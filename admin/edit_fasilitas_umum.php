  ...
  <div class="container card p-2">
    <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="mb-2">
        ...
        <img src="../vendor/img/fasilitas_umum/<?= $ResultDetailFasilitasUmum['gambar']; ?>" style="width: 120px; height: 70px; margin-bottom: 10px;">
        <input type="file" class="form-control" name="gambar" id="gambar">
      </div>

      <!-- Tombol Edit -->
      <button class="btn btn-primary" type="submit" name="fasilitas_umum">Edit</button>
      <a href="fasilitas_umum.php" class="btn btn-warning">Kembali</a>
